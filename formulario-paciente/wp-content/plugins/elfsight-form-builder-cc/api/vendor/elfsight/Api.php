...
namespace ElfsightFormBuilderApi\Core;
...
//        });
    ...
    public function initDebug($debug_mode) {
        if (class_exists('\ElfsightFormBuilderApi\Debug')) {
            return new \ElfsightFormBuilderApi\Debug($this, $debug_mode);
        } else {
            return new \ElfsightFormBuilderApi\Core\Debug($this, $debug_mode);
        }
    }

    public function initOptions($config) {
        if (class_exists('\ElfsightFormBuilderApi\Options')) {
            return new \ElfsightFormBuilderApi\Options($this->Helper, $config);
        } else {
            return new \ElfsightFormBuilderApi\Core\Options($this->Helper, $config);
        }
    }
