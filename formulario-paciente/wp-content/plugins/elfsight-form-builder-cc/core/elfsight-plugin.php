...
if (!class_exists('ElfsightFormBuilderPlugin')) {
    class ElfsightFormBuilderPlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightFormBuilderPluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightFormBuilderWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightFormBuilderPluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightFormBuilderWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightFormBuilderVCElement($config, $this->widgetsApi);
