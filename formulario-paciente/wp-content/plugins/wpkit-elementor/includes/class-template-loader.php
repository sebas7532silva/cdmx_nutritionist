 ...
 * @version   1.2.0
 */
if ( ! class_exists( 'WKE_Template_Loader' ) ) {
	/**
	 * Template loader.
	 *
	...
	class WKE_Template_Loader {
		 ...
		 * @var string
		 */
		protected $theme_template_directory = 'wpkit-elementor';
		/**
		 ...
		 * @var string
		 */
		protected $plugin_directory = WKE_DIR;
		/**
