...
class WKE_WOO_Product_Carousel_Widget extends Widget_Base {

    public function get_name() {
        return 'woo-product-carousel';
    }

    public function get_title() {
        return apply_filters('wke_woo_product_carousel_title',esc_html__('WC Product Carousel', 'wpkit-elementor'));
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_woo_product_carousel_slider',
            [
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::SELECT,
                'label' => esc_html__('Image Size', 'wpkit-elementor'),
                'default' => 'medium',
                'description' => esc_html__('Choose the product image size, if you found the image is blur, just select large size.', 'wpkit-elementor'),
                'options' => [
                    'thumbnail' => esc_html__( 'Thumbnail', 'wpkit-elementor' ),
                    'medium' => esc_html__( 'Medium', 'wpkit-elementor' ),
                    'large' => esc_html__( 'Large', 'wpkit-elementor' ),
                    'Full' => esc_html__( 'Full', 'wpkit-elementor' )
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__('Thumbnail Bacgkround Color', 'wpkit-elementor'),
                'default' => '#eee',
                'selectors' => [
                    '{{WRAPPER}} .wke-carousel .swiper-slide .wke-carousel-thumbnail' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .wke-carousel .swiper-slide .wke-carousel-thumbnail' => 'border:1px solid {{VALUE}};',
                ],
        ...
        $this->add_control(
            'fullwidth',
            [
                'label' => esc_html__( 'Full Width', 'wpkit-elementor' ),
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::SWITCHER,
                'label' => esc_html__('Zoom in The Active Slide', 'wpkit-elementor'),
                'default' => '0',
                'label_on' => esc_html__( 'Yes', 'wpkit-elementor' ),
                'label_off' => esc_html__( 'No', 'wpkit-elementor' ),
                'return_value' => '1',
        ...
        $this->start_controls_section(
            'section_woo_product_carousel_title_style',
            [
        ...
        $this->start_controls_section(
            'section_woo_product_carousel_price_style',
            [
        ...
        $this->start_controls_section(
            'section_woo_product_carousel_icon_style',
            [
